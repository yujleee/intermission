...
export default function ReviewEdit({
    ...
    const { mutate: removeReview } = useMutation(
      ...
      {
        onSuccess: () => { console.log('삭제성공') },
        onError: () => { console.log('err in delete:', err)},
      }
    );
    const { mutate: reviseReview } = useMutation(
      ...
      {
        onSuccess: () => { console.log('수정성공') },
        onError: () => { console.log('err in edit:', err)},
      }
    );
    ...
    return(
        <Container>
            <EditButton
              ...
              onPress={onEdit}
            >
            <BtnTitle disabled={!newContents && !newratings}>
              수정하기
            </BtnTitle>
            </EditButton>
            ...
            <Rating 
                ...
                onFinishRating={(rating)=>{setNewratings(rating)}}
                ratingCount={5}
                imageSize={30}
                tintColor='#dd99f0'
            />
